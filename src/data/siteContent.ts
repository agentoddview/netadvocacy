...
export const siteContent: SiteContent = {
  ...
  legislators: {
    title: 'Transit Advocacy Map',
    description:
      "A live roster of officials and transit leaders we've met with, officials aware of Boston Bus Simulator, and scheduled meetings. Leaders aware of BBS are marked with *, while directly met leaders are shown without an asterisk.",
    items: [
      {
        id: 'phil-eng',
        name: 'Phil Eng',
